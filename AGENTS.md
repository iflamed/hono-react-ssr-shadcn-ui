...
- /drizzle.config.ts : Drizzle Kit configuration for the Node.js MySQL database
...
- /src/features/blog : Blog route handlers and database repository modules. Keep route-level dynamic imports so server chunks stay split.
